...
So 25 of 1 joltages steps, and 10 of the 3 joltage steps (remmeber add 1 for the adapter we choose to miss out).
...
One way to solve this is to count the paths from 0 to a each adapter joltage. `insert image later`
